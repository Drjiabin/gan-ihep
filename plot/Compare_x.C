void Compare_x(){
  ...
  //Time cut
  double timecutlow  = ((-120) - (-120))/240;
  double timecuthigh = ((120) - (-120))/240;
  //cut1 mc4, resamp
  TCut cut1=Form("posx>%f&&posx<%f",-120.,120.);
  //cut2 gan
  TCut cut2=Form("x>%f&&x<%f",timecutlow,timecuthigh);
  ...
  int n3=t_GAN->Draw("((-120) + x*240)>>"+h3name,cut2,"goff");
