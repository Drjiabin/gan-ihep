void Compare_theta(){
  ...
  TString name ="theta";
  double max = 3.14;
  double min = 5.206e-05;
  //Number of bins
  int nbin = 200;

  //Time cut
  double timecutlow  = (5.206e-05 - (5.206e-05))/3.13994794;
  double timecuthigh = (3.14 - (5.206e-05))/3.13994794;
  //cut1 mc4, resamp
  TCut cut1=Form("theta>%f&&theta<%f",5.206e-05,3.14);
  //cut2 gan
  TCut cut2=Form("theta>%f&&theta<%f",timecutlow,timecuthigh);
  ...
  int n3=t_GAN->Draw("(5.206e-05 + theta*3.13994794)>>"+h3name,cut2,"goff");
