void Compare_phi(){
  ...
  //Time cut
  double timecutlow  = ((-3.142) - (-3.142))/6.284;
  double timecuthigh = (3.142 - (-3.142))/6.284;
  //cut1 mc4, resamp
  TCut cut1=Form("phi>%f&&phi<%f",-3.142,3.142);
  //cut2 gan
  TCut cut2=Form("phi>%f&&phi<%f",timecutlow,timecuthigh);
