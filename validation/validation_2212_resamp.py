...
def main(argv):
    ...
    data_min = [-1.088, -3.142, 5.34e-05, -120, -120,-0.02]
    data_max = [8.19, 3.142, 2.75, 120, 120,0.9]


    with PdfPages('2212.pdf') as pdf:
        ...
        list1 = [1,2,3,4,5,6]
        list_range=[[-1.1,8.19],[-3.15,3.15],[0, 2.75],[-120, 120],[-120, 120],[-0.02, 0.9]]
        #gan vs geant4 1d
