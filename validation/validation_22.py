...
def main(argv):
    ...
    data_min = [-9.3, -3.15,5e-06,-120,-120,-0.03]
    data_max = [7.72,3.15,1.58,120,120,1.05]


    with PdfPages('cgan2_22.pdf') as pdf:
        path='/hpcfs/bes/mlgpu/cuijb/gan/generate_data'
        gan_data = load_gan_beam_data(path, 'cgan2_22.csv')
        input_height=512
        input_width=6
        ...
        list4 = [0,1,2]
        range_2d=[[[-9.3,7.72,-3.15,3.15],[-9.3,7.72,5e-06,1.58],[-3.15,3.15,5e-06,1.58]],
                      [[-125,125,-125,125]],
                      [[-9.3,7.72,-125,125],[-9.3,7.72,-125,125]],
                      [[-3.15,3.15,-150,150],[-3.15,3.15,-150,150]],
                      [[5e-06,1.58,-150,150],[5e-06,1.58,-150,150]],
                      [[-0.03,1.05,-9.3,7.72],[-0.03,1.05,-3.15,3.15],[-0.03,1.05,5e-06,1.58]],
                      [[-0.03, 1.05, -125, 125],[-0.03, 1.05, -125, 125]]]
