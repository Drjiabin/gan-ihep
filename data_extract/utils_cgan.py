...
def load_comet(comet_data):
    ...
    for pdg_id in pdg_list:
        ...
        #13
        attribute_min_13 = {'p':-1.2, 'p_phi':-3.2, 'p_theta':9.4e-05, 'x':-120, 'y':-120, 'time':-0.03}
        attribute_max_13 = {'p':7.1, 'p_phi':3.2, 'p_theta':2, 'x':120, 'y':120, 'time':0.61}
        #22
        attribute_min_22 = {'p' :-9.3, 'p_phi':-3.15, 'p_theta':5e-06, 'x':-120, 'y':-120, 'time':-0.03}
    ...
    trY = np.load('/hpcfs/bes/mlgpu/cuijb/gan/data/Geant4/11_13_22/labels.npy')
