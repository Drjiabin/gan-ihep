...
def load_comet(comet_data):
    ...
    for pdg_id in pdg_list:
        ...
        roo_data = quantile_transformer.fit_transform(roo_data)
        #min-max
        roo_data = (roo_data-quantile_min)/(quantile_max-quantile_min)
    ...
    trY = np.load('/hpcfs/bes/mlgpu/cuijb/gan/data/Geant4/eight_particles/labels.npy')
