...
from ops import *
from utils_sagan import *

class SAGAN(object):
    #初始化各类定义
    def __init__(self, sess, epoch, batch_size, z_dim, y_dim, dataset_name, checkpoint_dir, result_dir, log_dir, input_height, input_width,output_height, output_width,
